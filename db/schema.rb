...
ActiveRecord::Schema[7.1].define(version: 2026_07_14_010000) do
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.index ["account_id", "pinned"], name: "index_conversations_on_account_id_and_pinned"
  ...
  create_table "messages", id: :serial, force: :cascade do |t|
    ...
    t.index ["conversation_id", "pinned"], name: "index_messages_on_conversation_id_and_pinned"
